...
#ifdef CAF_WINDOWS
using setsockopt_ptr CAF_DEPRECATED("use caf.net instead") = const char*;
using getsockopt_ptr CAF_DEPRECATED("use caf.net instead") = char*;
using socket_send_ptr CAF_DEPRECATED("use caf.net instead") = const char*;
using socket_recv_ptr CAF_DEPRECATED("use caf.net instead") = char*;
using socket_size_type CAF_DEPRECATED("use caf.net instead") = int;
#else
using setsockopt_ptr CAF_DEPRECATED("use caf.net instead") = const void*;
using getsockopt_ptr CAF_DEPRECATED("use caf.net instead") = void*;
using socket_send_ptr CAF_DEPRECATED("use caf.net instead") = const void*;
using socket_recv_ptr CAF_DEPRECATED("use caf.net instead") = void*;
using socket_size_type CAF_DEPRECATED("use caf.net instead") = unsigned;
#endif

using signed_size_type CAF_DEPRECATED("use caf.net instead")
...
#else
using native_socket CAF_DEPRECATED("use caf.net instead") = int;
