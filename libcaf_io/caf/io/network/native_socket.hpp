...
#ifdef CAF_WINDOWS
using setsockopt_ptr CAF_IO_NETWORK_DEPRECATED = const char*;
using getsockopt_ptr CAF_IO_NETWORK_DEPRECATED = char*;
using socket_send_ptr CAF_IO_NETWORK_DEPRECATED = const char*;
using socket_recv_ptr CAF_IO_NETWORK_DEPRECATED = char*;
using socket_size_type CAF_IO_NETWORK_DEPRECATED = int;
#else
using setsockopt_ptr CAF_IO_NETWORK_DEPRECATED = const void*;
using getsockopt_ptr CAF_IO_NETWORK_DEPRECATED = void*;
using socket_send_ptr CAF_IO_NETWORK_DEPRECATED = const void*;
using socket_recv_ptr CAF_IO_NETWORK_DEPRECATED = void*;
using socket_size_type CAF_IO_NETWORK_DEPRECATED = unsigned;
#endif

using signed_size_type CAF_IO_NETWORK_DEPRECATED = std::make_signed_t<size_t>;
...
#ifdef CAF_WINDOWS
using native_socket CAF_IO_NETWORK_DEPRECATED = size_t;
...
#else
using native_socket CAF_IO_NETWORK_DEPRECATED = int;
