...
class CAF_DEPRECATED("use caf.net instead") CAF_IO_EXPORT ep_hash {
public:
  ep_hash();
...
struct CAF_DEPRECATED("use caf.net instead") CAF_IO_EXPORT ip_endpoint {
public:
...
template <>
struct CAF_DEPRECATED("use caf.net instead") hash<caf::io::network::ip_endpoint> {
