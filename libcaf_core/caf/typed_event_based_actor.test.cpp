...
server_actor::behavior_type typed_server3(server_actor::pointer self,
...
public:
  ...
  behavior_type wait4string() {
    return {
      ...
      [this](const std::string&) { self->become(wait4int()); },
    };
  }
...
TEST("chaining the behavior at runtime and skipping messages") {
