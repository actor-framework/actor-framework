...
public:
  ...
  /// Creates a \link caf::flow::generation \endlink that emits values by
  ...
  /// Creates a \link caf::flow::generation \endlink that emits `value` once.
  template <class T>
  ...
  /// Creates a \link caf::flow::generation \endlink that emits `value`
  /// repeatedly.
  template <class T>
  ...
  /// Creates a \link caf::flow::generation \endlink that emits ascending
  /// values.
  template <class T>
  ...
  /// Creates a \link caf::flow::generation \endlink that emits `num` ascending
